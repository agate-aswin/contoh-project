...
public class StartThankyouMessage
{
    ...
    {
        if (System.IO.File.Exists(Application.dataPath + "/Plugins/Julhiecio TPS Controller/Editor/DontShowThankYouMessage.jutps") == false)
        {
            ThankYouWindow.ShowWindow();
            System.IO.File.Create(Application.dataPath + "/Plugins/Julhiecio TPS Controller/Editor/DontShowThankYouMessage.jutps");
        }
    }
}
...
public class ThankYouWindow : EditorWindow
{
    ...
    {
        Application.OpenURL(Application.dataPath + "/Plugins/Julhiecio TPS Controller/Documentation JU TPS.pdf");
    }
    ...
    private void OnGUI()
    {
        if (Banner == null)
        {
            Banner = JUTPS.CustomEditorUtilities.GetImage("Plugins/Julhiecio TPS Controller/Textures/Editor/JU TPS BANNER.png");
        }
        if (Banner != null)
        {
